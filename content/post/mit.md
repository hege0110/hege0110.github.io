...
A look at the 5 years I spent at MIT. This post just explores how I chose to spend my time. Your experience **will** vary.
  <!--more-->
...
Assemble a robot and program it to identify colored blocks, and stack them. Sounds easy enough. Getting the robotic arm to stop before smacking itself against the floor (i.e. motor control) proved to be harder than it appeared
{{< youtube p40Jl4Owquc >}}

### 6.013 Electromagnetics & Applications
Learned how to read one of these
![](/img/smith.jpg#small_only)
Assembled one of these
![](/img/radar.png#small_only)
<!-- ### 6.861 Computer Intelligence -->
<!-- >it was the age of wisdom, it was the age of foolishness -->

### 18.0651 Matrix Methods in Data Analysis & Signal Processing
Deriving the method that allows for the photostitching of two images
